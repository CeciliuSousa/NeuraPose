# ==============================================================
# pre_processamento/utils/geometria.py
# ==============================================================
# Funções para transformações geométricas e afins, usadas para
# preparar inputs para o modelo RTMPose e mapear outputs de volta.

import cv2
import numpy as np
from neurapose.pre_processamento.configuracao.config import SIMCC_W, SIMCC_H
